...
// в order/index.html (TIERS, для отображения клиенту на форме заказа) и
// в servvv/routes/payments.js (recalcOrderTotal, для пересчёта при вебхуке
// оплаты). Поменял цену тут — обязательно поменяй и в тех двух файлах.
// Этот файл — то, что реально формирует сумму к списанию при создании
// платежа, так что расхождение здесь напрямую бьёт по деньгам.
